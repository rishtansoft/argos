...
import KnowledgeLoader from '../util-components/KnowledgeLoader';
  ...
  return (
    <div className='bg-gray-back py-6 dark:bg-dark-secondary dark:text-white'>
      <div className='container mx-auto'>
        ...
        {loading && <KnowledgeLoader loading={loading}></KnowledgeLoader>}
        ...
        {!loading && (
          <div className='charts grid grid-cols-4 gap-6'>
            ...
            <div className='line-chart col-span-1'>
              ...
              {data?.overall && (
                <ProgressBar overall={data.overall}></ProgressBar>
              )}
            </div>
